    ...
    db.close = function (cb) {
      ...
      db.realClose(function () {
        ...
        db.open(connectionString, function (error) {
          ...
          module.exports.debug && console.dir(self);
        });
      });
    };

    db.open(connectionString, function (error) {
      module.exports.debug && console.log("odbc.js : pool[%s] : pool.db.open callback()", self.index);
...
Pool.prototype.close = function (callback) {
  ...
  module.exports.debug && console.log("odbc.js : pool[%s] : pool.close()", self.index);
  ...
  setTimeout(function () {
    ...
    module.exports.debug && console.log("odbc.js : pool[%s] : pool.close() - setTimeout() callback", self.index);
    module.exports.debug && console.dir(pools);
    ...
    for (key in pools) {
      ...
      module.exports.debug &&
        console.log("odbc.js : pool[%s] : pool.close() - processing pools %s - connections: %s",
      ...
      for (x = 0 ; x < connections.length; x ++) {
        (function (x) {
          ...
          module.exports.debug &&
            console.log("odbc.js : pool[%s] : pool.close() - calling realClose() for connection #%s",
                        self.index, x);

          connections[x].realClose(function () {
            module.exports.debug &&
                console.log("odbc.js : pool[%s] : pool.close() - realClose() callback for connection #%s",
                            self.index, x);
